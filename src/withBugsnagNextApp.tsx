...
export const withBugsnagNextApp = (apiKeyOrOpts: string | Bugsnag.IConfig) => (
  ...
  class WithBugsnagNextAppWrapper extends Component {
    public static async getInitialProps(context: NextAppContext & IBugsnagNextAppContext): Promise<any> {
      let appProps = {
        pageProps: {},
      };
  ...
  if (process.env.NODE_ENV !== 'production') {
    (WithBugsnagNextAppWrapper as any).displayName = wrapDisplayName(ComposedComponent, 'withBugsnagNextApp');
  }
